...
public class ItemRequestController {
    ...
    @GetMapping("/all")
    public List<ItemRequestResponseDto> getAllRequests(@RequestHeader(USER_HEADER) @NotNull Long userId,
    ...
    public ItemRequestResponseDto getRequestById(@RequestHeader(USER_HEADER) @NotNull Long userId,
